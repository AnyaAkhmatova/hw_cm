...
from hw_cm.logger import setup_logging
from hw_cm.utils import read_json, write_json
...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, run_id=None):
        ...
        if self.resume is not None:
            ...
            if "resume" in self._config:
                self.resume = self._config["resume"]
                self.continue_from_checkpoint = self._config["continue_from_checkpoint"]
